...
$d = $data1->display_file($_SESSION['page'],$_SESSION['page1'],$_SESSION['page2']);
      ...
      echo "No files :(";
          ...
          foreach ($d as $key => $value) {
            ...
            if(is_string($k)){
              ...
              <td>
                <?php 
                      $until = substr($v,strrpos($v, "/")+1,strlen($v));
                       echo '<span>'.$until.'</span>'; 
                 ?>
              </td>
              <td>
                 
                <a href="download.php?file=./<?php echo $v; ?>" target="_blank">Download</a>
